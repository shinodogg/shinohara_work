...
Quiz.create(:question => 'cherry', :answer_a => '桜', :answer_b => '菊', :answer_c => '秋桜', :answer_d => '花', :answer => 'a')
Quiz.create(:question => 'car', :answer_a => 'バイク', :answer_b => '車', :answer_c => '足', :answer_d => '花', :answer => 'b')
Quiz.create(:question => 'pen', :answer_a => 'ベン', :answer_b => 'ベンツ', :answer_c => 'ペン', :answer_d => '連', :answer => 'c')
Quiz.create(:question => 'teeth', :answer_a => '葉', :answer_b => 'チーズ', :answer_c => 'かまぼこ', :answer_d => '歯', :answer => 'd')
Quiz.create(:question => 'table', :answer_a => 'ケーブル', :answer_b => '粘土', :answer_c => 'テーブル', :answer_d => 'レッドブル', :answer => 'c')
